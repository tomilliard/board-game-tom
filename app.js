...
<div class="user-menu" id="user-menu">
  ...
  <button class="user-menu-item" onclick="closeUserMenu();openMyCollection()">
...
<main class="main">
  ...
  <div class="page" id="page-players">
    ...
    <div id="cmp-wrap" class="cmp-wrap"></div>
...
<div class="modal-overlay" id="modal-profile" onclick="bgClose(event,'modal-profile')">
  <div class="modal" style="max-width:460px">
    ...
    <!-- Preview profil (grande carte, sticky sur mobile) -->
    <div id="pe-preview-card" class="pe-preview-card">
      <div id="pe-preview-bg" class="pe-preview-bg"></div>
      <div class="pe-preview-inner">
        <div id="pe-avatar-preview-wrap" style="position:relative;width:96px;height:96px;flex-shrink:0;margin:0 auto">
          ...
          <div id="pe-frame-preview" style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:118px;height:118px;pointer-events:none;z-index:2;display:none"><img id="pe-frame-img" style="width:100%;height:100%;object-fit:contain"></div>
        </div>
        <div style="text-align:center;margin-top:10px">
          <div style="font-size:16px;font-weight:600;color:var(--text)" id="pe-name-preview">Votre nom</div>
          <div id="pe-title-preview" class="pe-title-preview"></div>
          <div style="font-size:11px;color:var(--text-faint);margin-top:4px">Aperçu en direct de votre profil</div>
        </div>
      </div>
    </div>
...
<div class="modal-overlay" id="modal-challenge" onclick="bgClose(event,'modal-challenge')">
  <div class="modal" style="max-width:460px">
    ...
    <div class="form-row">
      <label>Jeu <span class="req">*</span></label>
      <div class="ch-rand">
        <div class="ch-dur-tabs">
          <button type="button" class="ch-dur-btn active" data-dur="" onclick="setChDur('')">Peu importe</button>
          <button type="button" class="ch-dur-btn" data-dur="court" onclick="setChDur('court')">Court</button>
          <button type="button" class="ch-dur-btn" data-dur="moyen" onclick="setChDur('moyen')">Moyen</button>
          <button type="button" class="ch-dur-btn" data-dur="long"  onclick="setChDur('long')">Long</button>
        </div>
        <button type="button" class="ch-rand-btn" onclick="rollRandomGame()">🎲 Jeu au hasard</button>
      </div>
      <select class="fselect" id="ch-game" style="margin-top:8px"></select>
      <div id="ch-rand-info" class="ch-rand-info"></div>
    </div>
    <div class="form-row">
...
<!-- Info titre (comment il a été obtenu) -->
<div class="modal-overlay" id="modal-title-info" onclick="bgClose(event,'modal-title-info')">
  <div class="modal" style="max-width:360px">
    <div class="modal-header">
      <h2 class="modal-title">Titre</h2>
      <button class="btn-close" onclick="closeModal('modal-title-info')">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
          <line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/>
        </svg>
      </button>
    ...
    <div class="ti-body">
      <div class="ti-icon" id="title-info-icon">🏅</div>
      <div class="ti-name" id="title-info-name"></div>
      <div class="ti-cond" id="title-info-cond"></div>
    </div>
  </div>
</div>

<!-- Ma collection perso -->
<div class="modal-overlay" id="modal-mycoll" onclick="bgClose(event,'modal-mycoll')">
  <div class="modal" style="max-width:560px">
    <div class="modal-header">
      <h2 class="modal-title">🎲 Ma collection</h2>
      <button class="btn-close" onclick="closeModal('modal-mycoll')">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
          <line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/>
        </svg>
      </button>
    ...
    <div class="mc-tabs">
      <button class="mc-tab active" data-mctab="mine" onclick="switchMcTab('mine')">Mes jeux</button>
      <button class="mc-tab" data-mctab="everyone" onclick="switchMcTab('everyone')">Tout le monde</button>
      <button class="mc-tab" data-mctab="compare" onclick="switchMcTab('compare')">Comparer</button>
    </div>
    <div id="mc-mine"></div>
    <div id="mc-everyone" style="display:none"></div>
    <div id="mc-compare" style="display:none"></div>
  </div>
</div>
