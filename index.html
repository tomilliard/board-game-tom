...
<header class="site-header">
  <div class="site-header-inner">
    ...
    <nav class="nav-tabs">
      <button class="nav-tab active" onclick="showPage('games',this)">
...
<nav class="mobile-nav">
  <div class="mobile-nav-inner">
    <button class="mobile-nav-tab active" id="mnav-games"
  ...
  <div class="page" id="page-social">
    <div style="display:flex;gap:8px;margin-bottom:1.5rem;flex-wrap:wrap;
      ...
      <div class="tabs" style="margin-bottom:0">
        ...
        <button class="tab" onclick="setSocialTab('chat',this)">💬 Chat</button>
    ...
    <div id="social-chat" style="display:none">
      <div class="chat-wrap">
